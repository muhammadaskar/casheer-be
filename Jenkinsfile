    ...
    stages {
        ...
        stage('Set Environment Variables') {
            steps {
                ...
                sh "sed -i 'ALLOW_ORIGIN_PROD=.*/ALLOW_ORIGIN_PROD=${ALLOW_ORIGIN_PROD}/' .env"
                sh "sed -i 'ALLOW_ORIGIN_DEV=.*/ALLOW_ORIGIN_DEV=${ALLOW_ORIGIN_DEV}/' .env"
                sh "sed -i 'ALLOW_ORIGIN_LOCAL=.*/ALLOW_ORIGIN_LOCAL=${ALLOW_ORIGIN_LOCAL}/' .env"
            }
        }
